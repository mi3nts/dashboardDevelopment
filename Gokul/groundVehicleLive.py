...
############################################## BODY ###################################################################
        html.Div([
           html.Div([ 
            ...
            html.Div([
                html.Div(
                    [html.H6("Particulate Matter (PALAS FRG)", className="graph__title")]
                ),
           ...
           ############### Bin #################### 
            html.Div([
                    html.Div(
                        [html.H6("Size Distribution (PALAS FRG)", className="graph__title")]
                    ),
        ...
        ############### Contour #################### 
            ...
            html.Div([
                html.Div(
                    [html.H6("Contour Distribution (PALAS FRG)", className="graph__title")]
                ),
